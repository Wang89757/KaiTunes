<?php
/* Smarty version 3.1.30, created on 2018-06-18 11:02:41
  from "D:\chenxu\wamp64\www\migu3.0\view\albumSong.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b2791515cb0c3_69012323',
...
function content_5b2791515cb0c3_69012323 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="album-index">
    <div class="album-top">
        <div class="album-picture"><img src="../images/album1_4.jpg"></div>
        <div class="album-info">
            <ul>
                <li>别</li>
                <li>薛之谦</li>
                <li>收录单曲：<span class='bianhong'>1</span>&nbsp首</li>
            </ul>
        </div>
    </div>
...
<script>
   ...
   $('.addsong').click(function(){
       if($('input[name=userInf-ID]', window.parent.document).val()==""){
           ...
           $.get("../Control/SongFunctionControl.php",{userID:userID,songID:songID,flag:"0"},function(msg){
               for(var key in msg){
                         alert(msg[key]);    
               }
           },"json")
