<?php
/* Smarty version 3.1.30, created on 2018-06-20 04:53:25
  from "D:\chenxu\wamp64\www\migu3.0\view\singerIndex.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b29ddc5901381_56565006',
...
function content_5b29ddc5901381_56565006 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="singer-index">
    <div class="singer-top">
        <div class="singer-picture"><img src="../images/singer1.jpg"></div>
        <div class="singer-info">
            <ul>
                <li>薛之谦</li>
                <li>单曲：<span class="bianhong">17</span>&nbsp&nbsp&nbsp专辑：<span class="bianhong">11</span></li>
                <li><p><span>歌手简介：</span>薛之谦（Joker Xue），1983年7月17日出生于上海，华语流行乐男歌手、影视演员、音乐制作人，毕业于格里昂酒店管理学院。 薛之谦坦言，不管是不是艺人，肯定都会想把自己本分的工作做到最好，下一次就要更好，但之后该如何超越？万一不好又要如何坚持信念继续走下去？所以</p></li>
            </ul>
        </div>
    </div>
...
?>
                ...
                <input type="hidden" name='singerID' value="1">
                </div>
            </div>
            <div class="d-tab2">
                <div class="albumbox">
                <ul>
                    ...
                    <span>动物世界</span>
                                        ...
                                        <li><a href="albumControl.php?albumID=8&singerID=1">
                            <img src="../images/album1_1.jpg" alt="">
                    <span>肆无忌惮</span>
                    </a></li>
                                        <li><a href="albumControl.php?albumID=9&singerID=1">
                            <img src="../images/album1_9.jpg" alt="">
                    <span>高尚</span>
                    </a></li>
                                        <li><a href="albumControl.php?albumID=10&singerID=1">
                            <img src="../images/album1_3.jpg" alt="">
                    <span>我害怕</span>
                    </a></li>
                                        <li><a href="albumControl.php?albumID=11&singerID=1">
                            <img src="../images/album1_2.jpg" alt="">
                    <span>摩天大楼</span>
                    </a></li>
