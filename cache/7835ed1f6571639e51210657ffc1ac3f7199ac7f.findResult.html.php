<?php
/* Smarty version 3.1.30, created on 2018-06-20 02:11:41
  from "D:\chenxu\wamp64\www\migu3.0\view\findResult.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b29b7dd8b6746_40730781',
...
function content_5b29b7dd8b6746_40730781 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="migu-header">
        <div class="header-top">
            ...
            <div class="header-right">
                ...
                <div class="find">
                    <input type="text" name="content" value="薛之谦">
  ...
  <div class="album-index" style='padding-top: 30px'>
    <div class="album-songs">
            <h2>搜索到<span class="bianhong">&nbsp&nbsp17</span>&nbsp&nbsp条记录</h2>
...
?>
                ...
                <div class="fenye">
                    ...
                    <input type="hidden" name='findTotal' value="17">
                    <input type="hidden" name='currenName' value="薛之谦">
                </div>
            </div>
        </div>     
</div>
