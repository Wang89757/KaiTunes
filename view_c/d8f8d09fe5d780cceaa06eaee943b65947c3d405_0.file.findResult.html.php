<?php
/* Smarty version 3.1.30, created on 2019-05-06 11:01:28
  from "D:\chenxu\wamp64\www\kaimusic\KaiTunes--src\view\findResult.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5cd01408815bd4_92379936',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd8f8d09fe5d780cceaa06eaee943b65947c3d405' => 
    array (
      0 => 'D:\\chenxu\\wamp64\\www\\kaimusic\\KaiTunes--src\\view\\findResult.html',
      1 => 1529424287,
      2 => 'file',
    ),
  ),
...
function content_5cd01408815bd4_92379936 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
">
  ...
  <div class="album-index" style='padding-top: 30px'>
    <div class="album-songs">
            <h2>搜索到<span class="bianhong">&nbsp&nbsp<?php echo $_smarty_tpl->tpl_vars['result']->value[2][0]['Total'];?>
</span>&nbsp&nbsp条记录</h2>
        <div class="album-song">
            <div class="tablebox">
                ...
                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['result']->value[3], 'value');
...
?>
                ...
                <div class="fenye">
                    ...
                    <input type="hidden" name='findTotal' value="<?php echo $_smarty_tpl->tpl_vars['result']->value[2][0]['Total'];?>
">
                    <input type="hidden" name='currenName' value="<?php echo $_smarty_tpl->tpl_vars['content']->value;?>
">
                </div>
            </div>
        </div>     
...
//播放歌曲
   ...
   var Total=$('input[name=findTotal]').val();
    $('.M-box2').pagination({
        coping: true,
        homePage: '首页',
        endPage: '末页',
    ...
    function findAjax(name,yema){
          $.ajax({
                ...
                data:{name:name,yema:yema,falg:5},  
                dataType:"json",
