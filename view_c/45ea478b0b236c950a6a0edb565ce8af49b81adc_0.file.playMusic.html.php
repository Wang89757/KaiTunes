<?php
/* Smarty version 3.1.30, created on 2019-05-06 12:44:04
  from "D:\chenxu\wamp64\www\kaimusic\KaiTunes--src\view\playMusic.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5cd02c14594554_56938218',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '45ea478b0b236c950a6a0edb565ce8af49b81adc' => 
    array (
      0 => 'D:\\chenxu\\wamp64\\www\\kaimusic\\KaiTunes--src\\view\\playMusic.html',
      1 => 1557146633,
      2 => 'file',
    ),
  ),
...
function content_5cd02c14594554_56938218 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
<title>KaiTunes音乐</title>
...
<div id="jp_container_N" class="jp-video jp-video-270p jp-state-playing" role="application" aria-label="media player" style="left: 0px; height: 175px; bottom: 20px;">
	<div class="jp-type-playlist">
		<div id="jquery_jplayer_N" class="jp-jplayer" style="width: 90px; height: 90px;">
			...
			<audio id="jp_audio_0" preload="metadata" src="http://music.163.com/song/media/outer/url?id=31473269.mp3" title=""></audio>
			<video id="jp_video_0" preload="metadata" title="" style="width: 0px; height: 0px;"></video>
		</div>
		<div class="jp-gui">
				...
				<ul style="height: 1000px; display: block; top: 0px;">
					<li>
						<div>
							...
							<a href="javascript:;" class="jp-playlist-item" tabindex="0"><span class="jp-artist" style="transform: rotate(180deg);"></span></a>
						</div>
					</li>
					<li class="">
						<div>
					...
					<li class="jp-playlist-current" style="display: list-item;">
						<div>
							<a href="javascript:;" class="jp-playlist-item-remove">×</a>
							<a href="javascript:;" class="jp-playlist-item jp-playlist-current" tabindex="0"><span class="jp-artist" style="transform: rotate(180deg);"></span></a>
						</div>
					</li>
				</ul>
			</div>
...
>
<?php echo '<script'; ?>
 src="../js/playlist.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="../js/player_database.js"><?php echo '</script'; ?>
>
<!--播放器js-->
...
<?php echo '<script'; ?>
>
	//播放父函数，接收播放歌曲信息并将歌曲加入播放列表，同时播放歌曲。
	function fu(data) {
		myPlaylist.add({
